...
<style>
  *, *::before, *::after {{ box-sizing: border-box; margin: 0; padding: 0; }}
  ...
  .btn-anim:hover {{ background: #e6e6e6; }}
  .stats-row {{
    display: grid;
  ...
  #sankey-plot {{ width: 100%; margin: 0 auto; }}
  .legend-wrap {{
    display: flex;
    flex-wrap: wrap;
    gap: 6px 18px;
...
<div class="header">
  ...
  <input type="range" id="yr-slider" min="2010" max="2025" value="2025" step="1">
  <span class="year-badge" id="yr-badge">2025</span>
...
<div class="legend-wrap">
  {legend_lines}
  <span style="border-left:1px solid #cccccc;margin:0 6px;"></span>
  {legend_fares}
</div>
...
const LAYOUT = {{
  ...
  plot_bgcolor:  '#ffffff',
  font: {{ family: "'Segoe UI', Arial, sans-serif", size: 12, color: '#333333' }},
...
// Render inicial
Plotly.newPlot('sankey-plot', [makeSankeyTrace(2025)], LAYOUT, {{
  displayModeBar: true, displaylogo: false, toImageButtonOptions: {{ format: 'png', filename: 'sankey_metro_santiago', width: 1200, height: 1000, scale: 2 }},
  responsive: true,
}});
...
function goToYear(yr) {{
  ...
  Plotly.react('sankey-plot', [makeSankeyTrace(yr)], LAYOUT, {{
    displayModeBar: true, displaylogo: false, toImageButtonOptions: {{ format: 'png', filename: 'sankey_metro_santiago', width: 1200, height: 1000, scale: 2 }}, responsive: true,
  }});
}}
...
if __name__ == "__main__":
    html = build_html()
    output_path = "C:/Users/diego/OneDrive/Escritorio/Visualización/Grupo06_INF379_2026-1/Proyecto/visualizaciones/reutilizadas/sankey_metro_santiago.html"
